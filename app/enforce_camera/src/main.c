...
int main(int argc, char** argv) {
	...
	/********************************************************************************************************************/
	cp_app_register(CP_ECAM_TYPE, CP_ECAM_VAR, cp_ecam_version, CP_ECAM_VER, 
		(cp_app_create_handle)cp_ecam_create, (cp_app_destroy_handle)cp_ecam_destroy);

#if defined WIN32
	CP_APP_ENTRY_CONFIG_PATH("E:\\project_work\\project\\css_workspace\\cp_player\\app\\ecam360\\configs\\ecam.conf");
#endif 
