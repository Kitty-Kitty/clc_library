...
//typedef struct cp_hi3516c_av_codec_s					cp_hi3516c_av_codec_t;
...
#endif
	cp_hi3516c_av_conf_t									*av_conf;		/*表示输入配置信息*/
	cp_ecam_rtp_session_t								*rtp_session;	/**/
	cp_hi3516c_av_codec_configure_t						hacc;			/*表示当前的编码器配置信息*/
