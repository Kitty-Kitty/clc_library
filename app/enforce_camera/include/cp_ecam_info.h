...
#ifndef _CP_ECAM_INFO_INCLUDE_H_
#define _CP_ECAM_INFO_INCLUDE_H_
...
/* 前端设备基础信息                                                     */
/************************************************************************/
struct cp_ecam_info_s
{
	CP_APP_INFO_FIELDS
	cp_device_info_t				*device_info;																//本设备信息
	cp_device_info_t				*cener_server[CP_ECAM_MAX_CENTER_SERVER_NUMBER];							//表示中心设备列表
	cp_device_info_t				*client_background_server[CP_ECAM_MAX_CLIENT_SERVER_NUMBER];				//表示回显设备列表
	cp_device_info_t				*ecam_background_server[CP_ECAM_MAX_ECAM_SERVER_NUMBER];				//表示背景设备列表
	cp_device_info_t				*media_server[CP_ECAM_MAX_MEDIA_SERVER_NUMBER];							//表示媒体设备列表
