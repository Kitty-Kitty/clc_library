...
**************************************************************************/
#include "cp_ipc_hook_module_list.h"
#include "css_core.h"
...
/* 添加各个子模块管理器的支持                                             */
/************************************************************************/
CP_SUB_MODULE_MANAGER_DEPENDENT_BEGIN(ipc_hook)

CP_ADD_SUB_MANAGER_DEPENDENT(
cp_module_manager_register_t,
CP_MANAGER_DEPENDENT_CALLBACK_NULL,
CP_MODULE_MANAGER_REGISTER(cp_ipc_hook_manager_type_ipc_hook,
1, "hook_module_manager", "uv hook module manager", create_ipc_hook_manager, destroy_ipc_hook_manager));
...
/* 添加内存模块的支持                                                        */
/************************************************************************/
CP_MODULE_DEPENDENT_BEGIN(ipc_hook)

CP_ADD_MODULE_DEPENDENT(
	cp_ipc_hook_register_t,
	cp_ipc_hook_manager_type_ipc_hook,
...
// 	cp_css_rtp_hook_type_func_get_rtp_hook, cp_css_rtp_hook_type_ipc_media_close, cp_css_rtp_hook_type_ipc_media_close, cp_css_rtp_hook_type_end);
// 
// 	CP_CSS_ADD_ENTRY_DEPENDENT(cp_css_rtp_hook_type_global,
...
// 	CP_CSS_ADD_ERROR_DEPENDENT(cp_css_rtp_hook_type_ipc_media_close, 
// 	cp_css_rtp_hook_type_func_parse_gmf_data, cp_css_rtp_hook_type_end)
