...
typedef	struct cp_hi3519_av_channel_info_s							cp_hi3519_av_channel_info_t;
typedef	struct cp_hi3519_av_venc_info_s								cp_hi3519_av_venc_info_t;
typedef struct cp_hi3519_av_fisheye_info_s							cp_hi3519_av_fisheye_info_t;
typedef	struct cp_hi3519_av_vpss_channel_info_s						cp_hi3519_av_vpss_channel_info_t;
typedef	struct cp_hi3519_av_vpss_group_info_s						cp_hi3519_av_vpss_group_info_t;
...
/* h3519通道信息                                                        */
/************************************************************************/
struct cp_hi3519_av_channel_info_s
{
...
/* vpss通道信息                                                         */
/************************************************************************/
struct cp_hi3519_av_vpss_channel_info_s
{
...
/* vpss组信息                                                           */
/************************************************************************/
struct cp_hi3519_av_vpss_group_info_s
{
	VPSS_GRP									index;								//表示处理器通道号
	VPSS_GRP_ATTR_S								attr;								//表示属性信息
	VPSS_STITCH_BLEND_PARAM_S					stitch_blend_param;					//拼接融合高级属性结构体
	cp_hi3519_av_vpss_channel_info_t			vpss_list[CP_HI3519_AV_CODEC_MAX_VPSS_CHANNEL_NUMBER];						//表示定义的处理器列表
};
...
/* hi3519编码器信息                                                      */
/************************************************************************/
struct cp_hi3519_av_venc_info_s
{
...
/* hi3519编码器信息                                                      */
/************************************************************************/
struct cp_hi3519_av_fisheye_info_s
{
...
/* hi3519配置信息                                                        */
/************************************************************************/
struct cp_hi3519_av_conf_s
{
	cp_hi3519_av_codec_t						*hi3519_av_codec;												//编码器信息
	...
	cp_hi3519_av_venc_info_t					venc_list[1];													//表示定义的编码器列表
	...
	cp_hi3519_av_fisheye_info_t					fisheye_info[CP_HI3519_AV_CODEC_MAX_CHANNEL_NUMBER];			//表示fisheye配置信息
	cp_hi3519_av_vpss_group_info_t				stitch_vpss_info;												//表示vpss信息
	cp_hi3519_av_vpss_group_info_t				process_vpss_info[CP_HI3519_AV_CODEC_MAX_CHANNEL_NUMBER];	//表示vpss信息
	cp_hi3519_av_channel_info_t					channel_list[CP_HI3519_AV_CODEC_MAX_CHANNEL_NUMBER];			//表示定义的通道列表
#endif
};
...
/*启动一个hi3519 venc 设备*/
cp_int32_t	start_hi3519_av_one_venc(cp_hi3519_av_codec_t *hi3519_av_codec, cp_hi3519_av_conf_t *hi3519_av_conf, cp_hi3519_av_venc_info_t *venc_info);
