...
#ifndef _CP_IPC_HEARTBEAT_INCLUDE_H_
#define _CP_IPC_HEARTBEAT_INCLUDE_H_
...
#define	CP_IPC_HEARTBEAT_DEFAULT_INTERVAL_NS			10000000000LL			//表示默认的心跳数值
#define	CP_IPC_HEARTBEAT_MIN_INTERVAL_NS				1000000000LL			//表示最小的心跳数值
...
struct cp_device_heartbeat_s
{
	...
	cp_char_t						device_info_data[CP_IPC_HEARTBEAT_DEFAULT_BUFFER_LENGTH];							//保存当前保存的，用于打印的设备信息
...
struct cp_heartbeat_manager_s
{
	...
	//cp_device_heartbeat_t			*device_heartbeats[CP_IPC_MAX_DEVICE_NUMBER];		//主要描述各个服务器对应的心跳发送信息
