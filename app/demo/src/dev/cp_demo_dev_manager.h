...
#ifndef	_CP_DEMO_DEV_MANAGER_INCLUDE_H_
#define _CP_DEMO_DEV_MANAGER_INCLUDE_H_
...
typedef struct cp_demo_dev_manager_s					cp_demo_dev_manager_t;



#pragma pack(1)

struct cp_demo_dev_manager_s
{
