...
int init_channel(cp_channel_manager_t *cm, cp_channel_t *mm);
int set_channel(cp_channel_t *mm, cp_int32_t index, cp_char_t *session, cp_module_t *module, cp_void_t *data);
