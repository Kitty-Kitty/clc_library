...
#ifndef	_CP_FUSION_PLAYER_EXTEND_INCLUDE_H_
#define _CP_FUSION_PLAYER_EXTEND_INCLUDE_H_

#include "cp_fusion_player_extend_core.h"



//typedef struct cp_fusion_player_extend_s					cp_fusion_player_extend_t;
...
#define CP_FUSION_PLAYER_EXTEND_FIELDS											\
		CP_EXTEND_FIELDS												\
...
/*                                                                      */
/************************************************************************/
struct cp_fusion_player_extend_s {
	CP_FUSION_PLAYER_EXTEND_FIELDS												/*表示时间模块信息*/
};
