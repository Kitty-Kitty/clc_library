...
cp_int32_t set_option_sdl_av_dev(cp_sdl_av_dev_t *sdl_av_dev, cp_int32_t optname, const cp_void_t* optval)
{
	...
	if (cp_fusion_player_dev_set_option_audio_buffer_size == optname ||
		cp_fusion_player_dev_set_option_video_buffer_size == optname) {
	...
	if (cp_fusion_player_dev_set_option_audio_delay == optname) {
	...
	if (cp_fusion_player_dev_set_option_audio_delay_sample_number == optname) {
