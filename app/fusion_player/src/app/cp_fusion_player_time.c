...
**************************************************************************/
#include "cp_fusion_player_time.h"
...
* 版权所有: fz & novigo
*
* 函数名称: cp_fusion_player_update_timestamp
*
* 函数说明: 更新ptp时间
*
* 参    数: cp_fusion_player_timestamp_t * pt						[in]参数说明
...
******************************************************************************************************/
cp_int32_t cp_fusion_player_update_timestamp(cp_fusion_player_timestamp_t *pt, cp_group_timestamp_t *gt)
{
...
* 版权所有: fz & novigo
*
* 函数名称: cp_fusion_player_systoptp
*
* 函数说明: 系统时间转ptp时间
*
* 参    数: cp_fusion_player_timestamp_t * pt						[in]参数说明
...
******************************************************************************************************/
cp_timespec_t cp_fusion_player_systoptp(cp_fusion_player_timestamp_t *pt, cp_timeval *sys_tv)
{
	cp_int64_t						tmp_ns = 0;
...
* 版权所有: fz & novigo
*
* 函数名称: cp_fusion_player_ptptosys
*
* 函数说明: ptp时间转系统时间
*
* 参    数: cp_fusion_player_timestamp_t * pt						[in]参数说明
...
******************************************************************************************************/
cp_timeval cp_fusion_player_ptptosys(cp_fusion_player_timestamp_t *pt, cp_timespec_t *ptp_ts)
{
	cp_int64_t						tmp_ns = 0;
	cp_timeval						tmp_tv = { 0, };
...
* 版权所有: fz & novigo
*
* 函数名称: cp_fusion_player_ptp_offset
*
* 函数说明: 时间差值
*
* 参    数: cp_fusion_player_timestamp_t * pt						[in]参数说明
...
******************************************************************************************************/
cp_timespec_t cp_fusion_player_ptp_offset(cp_fusion_player_timestamp_t *pt, cp_timespec_t *ptp_ts)
{
	cp_int64_t						tmp_ns = 0;
	cp_timespec_t					tmp_ts = { 0, };
	...
	tmp_sys_tv = cp_fusion_player_ptptosys(pt, ptp_ts);
