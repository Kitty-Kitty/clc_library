...
#ifndef	_CP_FUSION_PLAYER_CODEC_INCLUDE_H_
#define _CP_FUSION_PLAYER_CODEC_INCLUDE_H_
...
#define CP_FUSION_PLAYER_CODEC_FIELDS											\
		CP_CODEC_FIELDS													\
...
/*                                                                      */
/************************************************************************/
struct cp_fusion_player_codec_s {
	CP_FUSION_PLAYER_CODEC_FIELDS												/*表示时间模块信息*/
};
...
/* 设置解码的数据													    */
/************************************************************************/
#define CP_FUSION_PLAYER_CODEC_SET_MEDIA_CHANNEL_INFO(codec, in_mci)	do {	\
