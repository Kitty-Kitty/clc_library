...
#ifndef	_CP_FUSION_PLAYER_CODEC_MANAGER_INCLUDE_H_
#define _CP_FUSION_PLAYER_CODEC_MANAGER_INCLUDE_H_
...
typedef struct cp_fusion_player_codec_manager_s					cp_fusion_player_codec_manager_t;
...
/*                                                                      */
/************************************************************************/
#define CP_FUSION_PLAYER_CODEC_MANAGER_FIELDS																				\
		CP_CODEC_MANAGER_FIELDS																						\
		cp_module_manager_t							*hi3531_manager;		/*表示连接操作使用的定时器*/				\


struct cp_fusion_player_codec_manager_s
{
	CP_FUSION_PLAYER_CODEC_MANAGER_FIELDS
};
