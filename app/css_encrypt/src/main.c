...
int main(int argc, char** argv) {
	...
	/********************************************************************************************************************/
	cp_app_register(CP_CSS_ENCRYPT_TYPE, CP_CSS_ENCRYPT_VAR, cp_css_encrypt_version, CP_CSS_ENCRYPT_VER,
		(cp_app_create_handle)cp_css_encrypt_create, (cp_app_destroy_handle)cp_css_encrypt_destroy);

#if defined WIN32
	CP_APP_ENTRY_CONFIG_PATH("E:\\project_work\\project\\css_workspace\\cp_player\\app\\css_encrypt\\configs\\css.conf");
	// #else
	// 	CP_APP_ENTRY_CONFIG_PATH("/home/pi/Project/cp_player/build/debug/cp_player/css_encrypt/css.conf");
#endif 
