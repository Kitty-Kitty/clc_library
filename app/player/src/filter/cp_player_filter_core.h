...
#ifndef	_CP_PLAYER_FILTER_CORE_INCLUDE_H_
#define _CP_PLAYER_FILTER_CORE_INCLUDE_H_
...
#include "cp_player_filter_info.h"
#include "cp_player_filter_manager_info.h"
