...
int main(int argc, char** argv) {
	...
	/********************************************************************************************************************/
	cp_app_register(CP_PLAYER_TYPE, CP_PLAYER_VAR, cp_player_version, CP_PLAYER_VER, 
		(cp_app_create_handle)cp_player_create, (cp_app_destroy_handle)cp_player_destroy);

#if defined WIN32
	CP_APP_ENTRY_CONFIG_PATH("E:\\project_work\\project\\css_workspace\\cp_player\\app\\player\\configs\\css.conf");
// #else
// 	CP_APP_ENTRY_CONFIG_PATH("/home/pi/Project/cp_player/build/debug/cp_player/configs/css.conf");
#endif 
