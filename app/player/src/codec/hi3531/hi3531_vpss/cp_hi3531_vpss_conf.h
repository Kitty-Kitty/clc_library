...
#ifndef _CP_HI3531_VPSS_CONF_INCLUDE_H_
#define _CP_HI3531_VPSS_CONF_INCLUDE_H_


#include "cp_core.h"
#include "cp_module_core.h"
#include "cp_hi3531_vpss_conf_string.h"




//定义配置数量
#define		CP_HI3531_VPSS_CAMERA_CONFIGURE_SIZE					2

//定义overlap point 数量
#define		CP_HI3531_VPSS_OVERLAP_POINT_SIZE						4


typedef struct	cp_hi3531_vpss_auto_configure_s						cp_hi3531_vpss_auto_configure_t;
typedef struct	cp_hi3531_vpss_overlap_point_s						cp_hi3531_vpss_overlap_point_t;
typedef struct	cp_hi3531_vpss_stitch_configure_s					cp_hi3531_vpss_stitch_configure_t;
typedef struct	cp_hi3531_vpss_cylind_stitch_correction_s			cp_hi3531_vpss_cylind_stitch_correction_t;
typedef	struct	cp_hi3531_vpss_camera_configure_s					cp_hi3531_vpss_camera_configure_t;
typedef struct	cp_hi3531_vpss_configure_s							cp_hi3531_vpss_configure_t;
typedef enum	cp_hi3531_vpss_mode_enum							cp_hi3531_vpss_mode_e;


/************************************************************************/
/* codec的工作模式                                                       */
/************************************************************************/
enum cp_hi3531_vpss_mode_enum
{
	cp_hi3531_vpss_mode_none = 0,
	cp_hi3531_vpss_mode_vi_venc,
	cp_hi3531_vpss_mode_vi_stitch_vpss_venc,
	cp_hi3531_vpss_mode_vi_fisheye_stitch_vpss_venc,
	cp_hi3531_vpss_mode_vi_fisheye_process_vpss_venc,
	cp_hi3531_vpss_mode_vi_fisheye_process_vpss_stitch_vpss_venc,
	cp_hi3531_vpss_mode_vi_process_vpss_fisheye_stitch_vpss_venc,
	cp_hi3531_vpss_mode_end
};
...
/* auto配置信息                                                        */
/************************************************************************/
struct cp_hi3531_vpss_auto_configure_s
{
...
/* overlap point配置                                                    */
/************************************************************************/
struct cp_hi3531_vpss_overlap_point_s
{
...
/*双路拼接校正配置                                                       */
/************************************************************************/
struct cp_hi3531_vpss_cylind_stitch_correction_s
{
...
/* stitch配置信息                                                        */
/************************************************************************/
struct cp_hi3531_vpss_stitch_configure_s
{
	cp_int32_t								out_width;												//拼接后图像的宽度。要求4 对齐，取值范围：[64, 8188]。
	cp_int32_t								out_height;												//拼接后图像的高度。要求4 对齐，取值范围：[64, 4608]。
	cp_hi3531_vpss_overlap_point_t		overlap_points[CP_HI3531_VPSS_OVERLAP_POINT_SIZE];	//overlap point数量
	cp_hi3531_vpss_auto_configure_t		auto_config;											//表示是否自动配置
	cp_hi3531_vpss_cylind_stitch_correction_t		csc[CP_HI3531_VPSS_CAMERA_CONFIGURE_SIZE];	//表示柱面校正配置
};

/************************************************************************/
/* 摄像头配置信息                                                        */
/************************************************************************/
struct cp_hi3531_vpss_camera_configure_s
{
...
/* 音频处理相关配置                                                      */
/************************************************************************/
struct cp_hi3531_vpss_configure_s
{
	...
	cp_hi3531_vpss_camera_configure_t		camera_configs[CP_HI3531_VPSS_CAMERA_CONFIGURE_SIZE];		//表示摄像头配置文件数量
	cp_hi3531_vpss_stitch_configure_t		stitch_config;												//表示stitch configure数据
};
