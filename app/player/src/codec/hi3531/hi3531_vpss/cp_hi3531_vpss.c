	...
	const cp_hi3531_vpss_info_t *hi3531_vpss_info)
{
	...
	if (tmp_ret_int) {
		cp_module_log(error, hi3531_vpss, "hi3531_vpss_parse_configure() error.");
		return -1;
	}

	cp_module_log(notice, hi3531_vpss, "init() successed.");
	return 0;
}
	...
	const cp_hi3531_vpss_info_t *hi3531_vpss_info)
{
	...
	if (!hi3531_vpss->video_file) {
		cp_module_log(error, hi3531_vpss,
...
#endif
	cp_module_log(notice, hi3531_vpss, "open() successed.");
	return 0;
}
...
cp_int32_t set_option_hi3531_vpss(cp_hi3531_vpss_t *hi3531_vpss, cp_int32_t optname, const cp_void_t* optval)
{
	...
	cp_module_log(notice, hi3531_vpss, "set_option_hi3531_vpss() failed");
