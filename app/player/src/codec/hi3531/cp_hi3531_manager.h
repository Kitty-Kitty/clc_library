...
#ifndef	_CP_HI3531_MANAGER_INCLUDE_H_
#define _CP_HI3531_MANAGER_INCLUDE_H_
...
//typedef struct cp_hi3531_manager_s								cp_hi3531_manager_t;
...
/*                                                                      */
/************************************************************************/
#define CP_HI3531_MANAGER_FIELDS																					\
		CP_CODEC_MANAGER_FIELDS																						\
		cp_hi3531_configure_t									conf_info;		/*表示hi3531配置信息*/				\


struct cp_hi3531_manager_s
{
	CP_HI3531_MANAGER_FIELDS
};
