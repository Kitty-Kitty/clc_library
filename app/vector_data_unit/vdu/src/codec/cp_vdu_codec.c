...
/*模块创建接口，表示创建一个模块*/
cp_int32_t init_vdu_codec(cp_vdu_codec_t *vdu_codec, const cp_vdu_codec_info_t *info);
/*模块打开运行接口，在模块init之后，会被调用*/
cp_int32_t open_vdu_codec(cp_vdu_codec_t *vdu_codec, const cp_vdu_codec_info_t *info);
