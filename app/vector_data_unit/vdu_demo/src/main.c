...
int main(int argc, char** argv) {
	...
	/********************************************************************************************************************/
	cp_app_register(CP_VDU_DEMO_TYPE, CP_VDU_DEMO_VAR, cp_vdu_demo_version, CP_VDU_DEMO_VER, 
		(cp_app_create_handle)cp_vdu_demo_create, (cp_app_destroy_handle)cp_vdu_demo_destroy);
