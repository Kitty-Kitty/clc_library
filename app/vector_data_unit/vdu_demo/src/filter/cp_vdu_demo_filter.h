...
#ifndef	_CP_VDU_DEMO_FILTER_INCLUDE_H_
#define _CP_VDU_DEMO_FILTER_INCLUDE_H_
...
#define CP_VDU_DEMO_FILTER_FIELDS											\
		CP_FILTER_FIELDS												\
...
/*                                                                      */
/************************************************************************/
struct cp_vdu_demo_filter_s {
	CP_VDU_DEMO_FILTER_FIELDS												/*表示时间模块信息*/
};
