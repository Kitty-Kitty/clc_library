...
#ifndef	_CP_VDU_DEMO_EXTEND_CORE_INCLUDE_H_
#define _CP_VDU_DEMO_EXTEND_CORE_INCLUDE_H_
...
#include "cp_vdu_demo_extend_info.h"
#include "cp_vdu_demo_extend_manager_info.h"
