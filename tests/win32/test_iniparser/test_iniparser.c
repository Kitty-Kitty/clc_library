...
#ifdef WIN32
#define  TMP_VALUE  0xFFFFFF
#else
#define  TMP_VALUE  0xFFFFFFFF
#endif
...
void Test_iniparser_getdouble(CuTest *tc)
{
	...
	CuAssertDblEquals(tc, TMP_VALUE, iniparser_getdouble(dic, NULL, TMP_VALUE), 0);
	CuAssertDblEquals(tc, -TMP_VALUE, iniparser_getdouble(dic, "dummy", -TMP_VALUE), 0);
